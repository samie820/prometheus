...
import com.app.prometheus.entities.PersonEntity;
import com.app.prometheus.web.models.Person;
import com.app.prometheus.repositories.PersonRepository;
...
public class PersonServiceImpl implements PersonService {
     ...
     */
    private final Function<PersonEntity, Person> entityToPerson = entity -> new Person(entity.getPersonId(), entity.getFirstName(), entity.getLastName(), entity.getEmail());
